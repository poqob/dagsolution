      ...
      <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="flex justify-center gap-4">
          <a 
            ...
            :title="link.name"
          >
            <svg v-if="link.icon === 'github'" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg v-if="link.icon === 'linkedin'" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
