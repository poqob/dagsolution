        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div class="flex gap-4">
              ...
              <a href="https://www.linkedin.com/in/mustafa-biçer-7164221b4" target="_blank" class="p-2 rounded-lg bg-background-hover text-text-secondary hover:text-accent-blue transition-colors">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
